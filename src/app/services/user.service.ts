...
uploadFile(file: File, tipo: 'avatar' | 'pdf'): Observable<any> {
  ...
  getMedicosDisponibles(): Observable<any> {
    ...
    return this.apiService.get('/medicos/disponibles');
  }
  ...
  getUserById(id: string): Observable<any> {console.log('[UserService] Obteniendo usuario por ID:', id);return this.apiService.get(`/users/${id}`);}
  updateProfile(userData: any): Observable<any> { console.log('[UserService] Actualizando perfil:', userData);return this.apiService.put('/user/profile', userData);}
